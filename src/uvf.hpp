 ...
 * @file uvf.hpp
 *
 * Implements the Universal Voxel Format, an attempt to provide a universal, not necessarily euclidean voxel format inspired by Minecraft's world structure.
**/
